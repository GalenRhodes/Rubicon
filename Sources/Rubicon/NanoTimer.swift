...
open class NanoTimer {
    ...
    /*===========================================================================================================================================================================*/
    /// Adds a number of timer cycles to skip to the existing number. The timer will skip a number of timer firings when told to.
    /// 
    ...
    /*===========================================================================================================================================================================*/
    /// Stop the timer. Waits for all the current timer calls in progress to finish executing. If the timer is already stopped then calling this method does nothing.
    ///
